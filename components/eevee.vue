...
<style lang="less" scoped>
  ...
  .chest {
    -webkit-animation:chest 10s .05s cubic-bezier(0.645, 0.045, 0.355, 1) both infinite;
  ...
  .fur:first-child {
    -webkit-animation:fur-center 10s .1s cubic-bezier(0.645, 0.045, 0.355, 1) both infinite;
  ...
  .fur:first-child>.patch:after {
    -webkit-animation:fur-center-patch-right 10s .07s cubic-bezier(0.645, 0.045, 0.355, 1) both infinite;
  ...
  .fur:nth-child(3) {
    -webkit-animation:fur-right 10s .15s cubic-bezier(0.645, 0.045, 0.355, 1) both infinite;
  ...
  .ear:before, .ear:after {
    -webkit-animation:ear 10s .1s cubic-bezier(0.645, 0.045, 0.355, 1) both infinite;
  ...
  .eye {
    ...
    background-image:-webkit-radial-gradient(ellipse 5px 10px at 50% 65%, #260f02 0, #260f02 99%, rgba(0, 0, 0, 0) 100%), -webkit-radial-gradient(ellipse 10px 20px at 50% 90%, #955d27 0, #955d27 99%, rgba(0, 0, 0, 0) 100%), -webkit-radial-gradient(ellipse 4px 6px at 55% 20%, #fff 0, #fff 99%, rgba(0, 0, 0, 0) 100%);
